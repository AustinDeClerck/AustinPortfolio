...
export class ProjectsService {
  ...
  projects: Project[] = [
    {id: 0, name: "VanParksVision", pictures: ["vanparksvision1.jpg","vanparksvision2.jpg","vanparksvision3.jpg"], projectLink: "https://dtc-wsuv.org/projects/vanparksvision/", summary: "React app and website for Vancouver City Parks & Recreation!", description: "VanParksVision is a mobile app that uses augmented reality to reimagine upcoming Vancouver, Washington parks. The app showcases the changes coming to Vancouver parks and provides information helpful to guests, such as hours, amenities, and accessibility features. Designed to be used by all ages and abilities, the app is interactive, informative, and innovative.", tags: [Tag.PYTHON]},
